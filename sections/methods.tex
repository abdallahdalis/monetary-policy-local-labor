...
County Business Patterns exposure file covers 2{,}889. Joining them leaves
\textbf{2{,}887 counties} over 72 quarters, and that is the estimation sample
in both windows.

Attrition beyond that is mechanical. The joined panel has 207{,}672
county-quarter observations in the full window and 161{,}528 excluding 2009
through 2012. The estimated specifications use 196{,}148 and 150{,}004
respectively, the difference being rows whose four leads are not observed.
Counts reported in the paper are estimation samples unless stated otherwise.
