...
verdict holds across sample windows and permutation schemes. Employment in
exposed counties was already moving before policy changed, so the estimate
cannot be read causally.
...
by a factor of six to twelve in the full window, and six to thirteen excluding
