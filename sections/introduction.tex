...
%  ✅ RESOLVED August 12, 2026. The macro DID differ: the .sty defines
%  `summarybox`, not `plainsummary`. Checked rather than assumed, and renamed
%  here to match the style file, which is canonical.
% -----------------------------------------------------------------------------
\begin{summarybox}
